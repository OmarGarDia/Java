...
public class MainScreen extends JFrame {
	...
	JLabel lbl_player1Number = new JLabel("");
	private int oContador = 0;
	JLabel lbl_player2Number = new JLabel("");
	boolean comprobador;
	...
	public MainScreen() {
		...
		JLabel lbl_player1 = new JLabel("Jugador X:");
		...
		JLabel lbl_player2 = new JLabel("Jugador O:");
